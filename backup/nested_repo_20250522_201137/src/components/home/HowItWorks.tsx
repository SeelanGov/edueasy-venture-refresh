...
const Step = ({ number, title, description, icon, isActive = false }: StepProps) => {
  return (
    <Card className={`border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300 ${isActive ? 'border-l-4 border-l-primary' : ''}`}>
        ...
        <div className="flex items-start">
          ...
          <div>
            <div className="mb-2 flex items-center gap-2">
              ...
              <Typography variant="h4" className="text-gray-800">{title}</Typography>
            </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                    <div className="text-center p-4 rounded-lg bg-gray-50">
                      <Typography variant="h3" className="text-primary font-bold">6,500+</Typography>
                      <Typography variant="small" className="text-gray-500">Successful Applications</Typography>
                    </div>
                    <div className="text-center p-4 rounded-lg bg-gray-50">
                      <Typography variant="h3" className="text-primary font-bold">98%</Typography>
                      <Typography variant="small" className="text-gray-500">Document Approval</Typography>
                    </div>
                    <div className="text-center p-4 rounded-lg bg-gray-50">
                      <Typography variant="h3" className="text-primary font-bold">4.9/5</Typography>
                      <Typography variant="small" className="text-gray-500">Student Satisfaction</Typography>
                    </div>
                  </div>
                </div>
              </div>
