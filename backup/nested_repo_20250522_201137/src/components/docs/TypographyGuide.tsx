          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <Typography variant="body">
                This is body text. It's the standard text size used throughout the application for general content.
              </Typography>
              <Typography variant="caption" color="muted">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardContent className="space-y-4 py-6">
            <Typography variant="h4" color="default">Default Text</Typography>
            ...
            <Typography variant="h4" color="muted">Muted Text</Typography>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="space-y-4 py-6">
            ...
            <Typography variant="h4" color="warning">Warning Text</Typography>
            <Typography variant="h4" color="error">Error Text</Typography>
            <Typography variant="h4" color="info">Info Text</Typography>
          </CardContent>
        </Card>
        
        <Card className="bg-cap-dark">
          <CardContent className="space-y-4 py-6">
            <Typography variant="h4" color="white">White Text</Typography>
        ...
        <CardContent className="py-6">
          <div className="prose max-w-none">
            ...
            <Typography variant="body-lg" className="mt-4 mb-6">
              EduEasy streamlines your university application process, making it easier to apply to multiple
              institutions across South Africa with a single application.
            </Typography>
            ...
            <Typography variant="body">
              Start by creating a comprehensive profile with your personal information, academic history,
              and contact details. This information will be used across all your applications.
            </Typography>
            ...
            <Typography variant="body">
              Upload your ID document, academic transcripts, and any supporting documents required for
              your applications. Our system will verify these documents meet institutional requirements.
            </Typography>
