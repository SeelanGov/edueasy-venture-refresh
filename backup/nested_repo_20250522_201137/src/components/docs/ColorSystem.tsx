          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <ColorCard 
                  name="Dark" 
                  variable="var(--cap-dark)" 
                  className="bg-cap-dark" 
                />
                <ColorCard 
                  name="Light" 
        ...
        <TabsContent value="usage">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <Typography variant="h4" className="mb-2">Color Variables</Typography>
                <Typography variant="body">
                  Always use CSS variables instead of hardcoded hex values. This ensures consistency and supports theming.
                </Typography>
              ...
              <div>
                <Typography variant="h4" className="mb-2">Tailwind Classes</Typography>
                <Typography variant="body">
              ...
              <div>
                <Typography variant="h4" className="mb-2">State Colors</Typography>
                <Typography variant="body">
