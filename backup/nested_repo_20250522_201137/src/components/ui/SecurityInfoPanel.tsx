...
const badgeDescriptions: Record<string, string> = {
  encryption: "Encryption: Your data is encrypted both in transit and at rest, ensuring only authorized access.",
  "data-protection": "Data Protection: We comply with global data protection standards to keep your information safe.",
  privacy: "Privacy: Your personal information is private and never shared without your consent.",
...
export const SecurityInfoPanel: React.FC<SecurityInfoPanelProps> = ({ badgeType }) => (
  <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-zinc-800 rounded-lg border border-blue-200 dark:border-zinc-700">
    ...
    <div className="flex-1">
      <div className="font-semibold text-blue-900 dark:text-blue-200 mb-1">{badgeType.charAt(0).toUpperCase() + badgeType.slice(1)} Security</div>
      <div className="text-sm text-blue-800 dark:text-blue-300">{badgeDescriptions[badgeType]}</div>
    </div>
    <Tooltip>
