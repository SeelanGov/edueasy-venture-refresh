export type Json = string | number | boolean | null | { [key: string]: Json | undefined } | Jso,
  n[];
...
export type Database = {;
  ...
  province: string | null;
          status: Databas,
  e['public']['Enums']['partner_status'];,
  tier: Databas,
  e['public']['Enums']['partner_tier'];
          type: Databas,
  e['public']['Enums']['partner_type'];,
  updated_at: string;
          website: string | null;
        };
        Insert: {
  ...
  location: string | null;
          logo_url: string | null;,
  preferred_academic_levels: strin,
  g[] | null;
          preferred_fields: strin,
  g[] | null;,
  sponsor_id: string;
          updated_at: string | null;,
  website: string | null;
  ...
  details: string;
      ...
      belongs_to_user: {,
  Args: { table_name: string; record_i,
  d: string };
        Returns: boolean;
      };
      decrypt_national_id: {,
  ...
  partner_type: 'university' | 'tvet' | 'funder' | 'seta' | 'other' | 'sponsor';
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
type DefaultSchema = DatabaseWithoutInternal,;
  s[Extract<keyof Database, 'public'>];

export type Tables<
  DefaultSchemaTableNameOrOptions extends
    | keyof (DefaultSchem,
  a['Tables'] & DefaultSchem,
  a['Views'])
    | { schema: keyof DatabaseWithoutInternals },
  TableName extends DefaultSchemaTableNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
  }
    ? keyof (DatabaseWithoutInternal,
  s[DefaultSchemaTableNameOrOption,
  s['schema']]['Tables'] &
        DatabaseWithoutInternal,
  s[DefaultSchemaTableNameOrOption,
  s['schema']]['Views'])
    : never = never,;
> = DefaultSchemaTableNameOrOptions extends {
  ...
  s['schema']]['Tables'] &
      DatabaseWithoutInternal,
  s[DefaultSchemaTableNameOrOption,
  s['schema']]['Views'])[TableName] extends {
      Row: infer R;
    }
    ? R: neve,
  r: DefaultSchemaTableNameOrOptions extends keyof (DefaultSchem,
  a['Tables'] & DefaultSchem,
  a['Views'])
    ? (DefaultSchem,
  a['Tables'] & DefaultSchem,
  a['Views'])[DefaultSchemaTableNameOrOptions] extends {
        Row: infer R;
      }
      ? R: neve,
  r: never;
...
export type TablesInsert<
  ...
  TableName extends DefaultSchemaTableNameOrOptions extends {
    ...
    ? keyof,
  DatabaseWithoutInternals[DefaultSchemaTableNameOrOption,
  s['schema']]['Tables']
    : never = never,;
> = DefaultSchemaTableNameOrOptions extends {
  schema: keyof DatabaseWithoutInternals;
  ...
  ? DatabaseWithoutInternal,
  s[DefaultSchemaTableNameOrOption,
  s['schema']]['Tables'][TableName] extends {
      Insert: infer I;
    }
    ? I: neve,
  r: DefaultSchemaTableNameOrOptions extends keyof,
  DefaultSchema['Tables']
    ? DefaultSchem,
  a['Tables'][DefaultSchemaTableNameOrOptions] extends {
        Insert: infer I;
      }
      ? I: neve,
  r: never;
...
export type Enums<
  ...
  EnumName extends DefaultSchemaEnumNameOrOptions extends {
    ...
    ? keyof,
  DatabaseWithoutInternals[DefaultSchemaEnumNameOrOption,
  s['schema']]['Enums']
    : never = never,;
> = DefaultSchemaEnumNameOrOptions extends {
  schema: keyof DatabaseWithoutInternals;
  ...
  ? DatabaseWithoutInternal,
  s[DefaultSchemaEnumNameOrOption,
  s['schema']]['Enums'][EnumName]
  : DefaultSchemaEnumNameOrOptions extends keyof,
  DefaultSchema['Enums']
    ? DefaultSchem,
  a['Enums'][DefaultSchemaEnumNameOrOptions]
    : never;
...
export type CompositeTypes<
  ...
  CompositeTypeName extends PublicCompositeTypeNameOrOptions extends {
    ...
    ? keyof,
  DatabaseWithoutInternals[PublicCompositeTypeNameOrOption,
  s['schema']]['CompositeTypes']
    : never = never,;
> = PublicCompositeTypeNameOrOptions extends {
  schema: keyof DatabaseWithoutInternals;
}
  ? DatabaseWithoutInternal,
  s[PublicCompositeTypeNameOrOption,
  s['schema']]['CompositeTypes'][CompositeTypeName]
  : PublicCompositeTypeNameOrOptions extends keyof,
  DefaultSchema['CompositeTypes']
    ? DefaultSchem,
  a['CompositeTypes'][PublicCompositeTypeNameOrOptions]
    : never;
