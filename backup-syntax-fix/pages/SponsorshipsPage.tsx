    ...
    <div className = "min-h-screen bg-gradient-to-b from-cap-teal/10 via-white to-cap-coral/10 py-0 px-0 relative">;
      ...
      <div className = "container max-w-4xl mx-auto px-4 pt-14 pb-10 md:pb-16 text-center relative">;
        <div className = "flex flex-col items-center gap-6">;
          ...
          <div className = "flex flex-col md: flex-row gap-4 w-full m,;
  d:justify-center my-4">
            <Button
              className = "w-full md: w-auto text-white bg-cap-teal hove,;
  r:bg-cap-teal/90 shadow-lg"
              size = "lg";
            ...
            <Button
              className = "w-full md: w-auto bg-cap-coral hove,;
  r:bg-cap-coral/90 text-white shadow-lg"
              size = "lg";
