      ...
      <div className = "container mx-auto py-20 px-4">;
        ...
        <div className = "grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
          {plans.map((plan, index) => (
            <Card
              key={index}
              className = {`relative transition-all duration-300 hover: shadow-lg hove,;
  r:scale-105 ${
                plan.popular
            ...
            >
              ...
              <CardContent>
                ...
                <div className = "bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-primary/20">;
              ...
              <CardFooter>
                <Button
                  ...
                  className = {`w-full transition-all duration-300 ${;
                    plan.popular
                      ? 'bg-gradient-to-r from-cap-teal to-blue-600 hover: from-cap-teal/90 hove,
  r:to-blue-700 shadow-lg'
        ...
        <div className = "mt-8 text-center">;
          <Card className = "max-w-md mx-auto bg-gradient-to-r from-blue-50 to-indigo-50 border-primary/20">;
            <CardContent className = "pt-6">;
              <Typography variant = "h4" className="mb-2">;
                1-on-1 Expert Sessions
              </Typography>
              <Typography variant = "large" className="text-primary mb-2">;
                R600 per session
              </Typography>
