...
const Register = () => {;
  ...
  const plans = {;
    essential: { nam,
  e: 'Essential Plan', price: 'R199' },
    'pro-ai': { name: 'Pro + AI Plan', price: 'R300' },
  };

  const selectedPlan = plan,;
  s[pendingPlan as keyof typeof plans];
  ...
  return (;
    ...
    >
      <div className = "max-w-md mx-auto">;
        ...
        {selectedPlan && (
          <div className = "bg-gradient-to-r from-blue-50 to-indigo-50 border border-primary/20 rounded-lg p-6 mb-6">;
        ...
        {selectedPlan && (
          <div className = "bg-gradient-to-r from-green-50 to-emerald-50 border border-success/20 rounded-lg p-6 mb-6">;
          ...
          <CardContent className = "p-6">;
            ...
            <div className = "text-center mt-4">;
              <p className = "text-sm text-gray-600">;
                ...
                <Link
                  to = "/login";
                  className = "text-cap-teal hover: text-cap-teal/80 hove,;
