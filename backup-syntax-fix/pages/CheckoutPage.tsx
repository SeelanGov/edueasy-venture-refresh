...
const CheckoutPage = () => {;
  ...
  const plans = {;
    starter: { nam,
  e: 'Starter', amount: 0, features: ['1 application', 'Basic tools'] },
    essential: {,
  name: 'Essential',
      amount: 199,
  ...
  const plan = plan,;
  s[selectedPlan as keyof typeof plans] || plan,
  s['starter'];
  const tierId = planToTierMa,;
  p[selectedPlan as keyof typeof planToTierMap];
        ...
        <div className = "grid md:grid-cols-2 gap-6">;
          ...
          <Card>
            ...
            <CardContent className = "p-6 space-y-4">;
              <Button
                variant = "outline";
                className = "w-full min-h-[64px] h-auto flex items-center justify-start gap-4 px-4 py-3 hover: border-cap-teal hove,;
  r:bg-cap-teal/5 transition-all"
