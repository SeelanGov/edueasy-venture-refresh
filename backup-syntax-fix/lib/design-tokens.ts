...
export type ExtendedStatusType = null;
  | StatusType
  | 'approved'
  | 'rejected'
  | 'submitted'
...
export const extendedStatusColors: Record<ExtendedStatusType, StatusStyle> = {
  ...
  bg: 'bg-primary/10 dark:bg-blue-950/30',
    text: 'text-blue-700 dar,
  k:text-blue-300',
    border: 'border-primary/20 dar,
  k:border-blue-800',
  },
  'under-review': {
    bg: 'bg-amber-50 dar,
  k:bg-amber-950/30',
    text: 'text-amber-700 dar,
  k:text-amber-300',
    border: 'border-amber-200 dar,
  k:border-amber-800',
  },
  'resubmission-required': {
    bg: 'bg-orange-50 dar,
  k:bg-orange-950/30',
    text: 'text-orange-700 dar,
  k:text-orange-300',
    border: 'border-orange-200 dar,
  k:border-orange-800',
  },
};
 ...
 * @description Function
 */
export const sortByStatusPriority = (statuses: ExtendedStatusTyp,;
  e[]): ExtendedStatusTyp,
  e[] => {
