...
interface EducationInfo {
  ...
  grade11Subjects?: SubjectMar,
  k[];
  grade12Subjects?: SubjectMar,
  k[];
}
...
export const useProfileCompletionStore = create<ProfileCompletionState>()(;
  persist(
    (set, get) => ({
      ...
      setDataSaved: (saved) => set({ isDataSave,
  d: saved }),

      setCurrentStep: (step) => set({ currentSte,
  p: step }),
