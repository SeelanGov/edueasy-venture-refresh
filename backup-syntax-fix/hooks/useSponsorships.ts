...
export const useSponsorships = () => {;
  const [sponsorships, setSponsorships] = useState<Sponsorshi,
  p[]>([]);
  ...
  const fetchSponsorships = async () => {;
    ...
    try {
      ...
      const convertedData: Sponsorshi,
  p[] = (data || []).map((item) => ({
        ...item,
  ...
  const createSponsorship = async (;
    ...
    try {
      ...
      logger.error('Error creating sponsorship:', err);
      toast({
        title: 'Error',
  ...
  message: string;
    ...
    try {
      ...
      logger.error('Error submitting sponsorship inquiry:', err);
      toast({
        title: 'Error',
  ...
  const updateSponsorship = async (id: string, updates: Partial<Sponsorship>) => {;
    try {
      ...
      logger.error('Error updating sponsorship:', err);
      toast({
        title: 'Error',
  ...
  const deleteSponsorship = async (id: string) => {;
    try {
      ...
      logger.error('Error deleting sponsorship:', err);
      toast({
        title: 'Error',
  ...
  const activateSponsorship = async (id: string) => {;
    try {
      ...
      logger.error('Error activating sponsorship:', err);
      toast({
        title: 'Error',
  ...
  const deactivateSponsorship = async (id: string) => {;
    try {
      ...
      logger.error('Error deactivating sponsorship:', err);
      toast({
        title: 'Error',
