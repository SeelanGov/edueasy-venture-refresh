            ...
            <div className = "space-y-3">;
              ...
              <Dialog open={isPartnerModalOpen} onOpenChange={setIsPartnerModalOpen}>
                <DialogTrigger asChild>
                  <Button
                    variant = "outline";
                    className = "w-full justify-start text-gray-300 border-gray-600 hover: bg-gray-700 hove,;
  r:text-white"
                          ...
                          {partnerTypes.map((partner) => {
                            ...
                            return (;
                              <div
                                ...
                                className = "group relative bg-card border border-border rounded-xl p-6 hover: border-primary/50 hove,;
  r:shadow-lg transition-all duration-300 cursor-pointer"
