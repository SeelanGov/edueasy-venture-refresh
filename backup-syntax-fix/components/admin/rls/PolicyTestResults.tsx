      ...
      <div className = "mb-4 p-4 border rounded-md bg-muted/30">;
        ...
        <div className = "grid grid-cols-3 gap-2 text-sm">;
          ...
          <div>
            ...
            <div className="font-medium text-success">{passedTests}</div>
          </div>
          <div>
            <div className = "text-muted-foreground">Failed</div>;
            <div className="font-medium text-destructive">{totalTests - passedTests}</div>
          </div>
        </div>
      </div>
            ...
            {tableResults.map((result, idx) => (
              ...
              >
                ...
                <Badge
                  ...
                  className={result.success ? 'border-green-600 text-green-700 bg-success/10' : ''}
                >
