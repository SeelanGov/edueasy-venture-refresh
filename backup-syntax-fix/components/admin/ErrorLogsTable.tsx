...
export const ErrorLogsTable = ({;
  ...
  const [resolvingIds, setResolvingIds] = useState<strin,
  g[]>([]);
  ...
  s[id] || 'Marked as resolved by admin';
                    ...
                    <TableCell className = "flex items-center gap-2">;
                      <div>
                        ...
                        <div className = "text-xs text-gray-500">;
                          {format(new Date(error.occurred_at), 'HH: m,
  m:ss')}
                        </div>
                      </div>
  ...
  s[error.id] || ''}
                                  ...
                                  className = "w-full p-2 border border-gray-300 rounded-md text-sm resize-none focus: border-primary focus:ring-1 focu,;
  s:ring-primary"
                                  rows={2}
