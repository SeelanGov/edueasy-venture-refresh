            ...
            <li key={step.id} className={`flex items-center ${isLast ? 'w-auto' : 'w-full'}`}>
              <div className = "flex flex-col items-center">;
                <div
                  ...
                  ${isCurrent ? 'border-blue-500 bg-primary/10 text-blue-500' : ''}
                  ${isComplete ? 'border-green-500 bg-success/10 text-green-500' : ''}
                  ${isError ? 'border-red-500 bg-destructive/10 text-red-500' : ''}
              ...
              {!isLast && (
                <div
                  ...
                  ${isComplete ? 'bg-success/100' : 'bg-gray-200'}
                `}
                >
                  {isComplete && (
