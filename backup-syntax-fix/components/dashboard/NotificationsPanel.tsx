...
export const NotificationsPanel = () => {;
  ...
  s[displayType] = [];
          ...
          group,
  s[displayType].push(notification);
          return groups;
        },
        {} as Record<string, Notificatio,
  n[]>,
      );
    }
  ...
  const renderNotificationContent = (notification: Notification) => {;
    return (;
      <div
        className = {`p-4 ${notification.is_read ? 'bg-white dark: bg-gray-800' : 'bg-primary/10 dar,;
  k:bg-blue-900/20'} transition-colors duration-200`}
      >
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant = "ghost" size="icon" className="relative">;
          ...
          {unreadCount > 0 && (
            <Badge
              className = "absolute -top-1 -right-1 px-1 min-w-[1.2rem] h-5 flex items-center justify-center bg-destructive/100 animate-pulse";
              variant = "destructive";
            >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align = "end" className="w-48">;
                ...
                <Button
                  variant = "ghost";
                  size = "sm";
                  className = "w-full justify-start text-xs text-red-500 hover: text-destructive hover:bg-destructive/10 dark:hove,;
  r:bg-red-950/10"
