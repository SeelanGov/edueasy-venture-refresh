    ...
    <FormField
      ...
      render={({ field, fieldState }) => (
        <FormItem className = "relative">;
          ...
          <FormControl>
            <div
              className={`relative transition-all duration-200 ${fieldState.invalid ? 'border-red-500 bg-destructive/10 animate-shake' : fieldState.isTouched && !fieldState.invalid ? 'border-green-500 bg-success/10' : ''} rounded-md`}
            >
              <Input
                {...field}
                type={type}
...
// .animate-fade-in { animation: fadeIn 0.3s ease-out; opacit,
  y: 1; }
