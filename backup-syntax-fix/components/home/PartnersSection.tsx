      ...
      <div className = "container mx-auto">;
        <div className = "text-center mb-12 md:mb-16">;
          <div className = "mb-6 flex justify-center">;
            <div className = "w-16 h-1 md: w-20 m,;
  d:h-1.5 bg-cap-coral rounded"></div>
          </div>
          ...
          <div className = "w-full flex justify-center md:justify-end">;
            <div className = "relative rounded-2xl overflow-hidden shadow-xl w-full max-w-sm group">;
              <OptimizedImage
                ...
                className = "w-full h-auto object-cover object-center rounded-2xl transition duration-300 group-hover: scale-105 group-hover:contrast-105 group-hove,;
  r:saturate-150"
