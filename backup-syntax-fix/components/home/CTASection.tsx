...
export const CTASection = () => {;
  ...
  const handleStartApplication = () => {;
    if (!user) {
      navigate('/register', { state: { fro,
  m: '/profile-completion' } });
      return;
    }
  ...
  d:gap-10 justify-center items-center">
                  <div className = "text-center md: text-left m,;
  d:w-1/2 space-y-6">
                    <div className = "flex items-center justify-center md:justify-start">;
                      <div className = "w-10 h-10 md: w-12 m,;
  d:h-12 bg-primary/20 rounded-full flex items-center justify-center mr-4">
                  ...
                  <div className = "md:w-1/2 flex flex-col gap-4 items-center">;
                    {user ? (
                      <Button
                        variant = "primary";
                        size = "lg";
                        className = "w-full md: w-auto text-lg py-6 md:py-7 m,;
  d:px-10"
  ...
  d:px-10"
                        ...
                        <Link to = "/login" className="w-full md:w-auto">;
                          <Button
                            variant = "outline";
                            size = "lg";
                            className = "w-full text-lg py-6 md: py-7 m,;
  d:px-10"
                          >
                ...
                <div className = "mt-10 text-center">;
                  <Link to = "/profile-demo">;
                    <Button
                      variant = "ghost";
                      className = "text-cap-teal hover: bg-cap-teal/10 hover:text-cap-teal m,;
  d:text-lg"
                    >
                      View Profile Demo
                    </Button>
