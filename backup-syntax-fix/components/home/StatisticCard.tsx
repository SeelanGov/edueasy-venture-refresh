...
export const StatisticCard = ({;
  ...
  const IconComponent = iconMa,;
  p[icon as keyof typeof iconMap] || CheckCircle;
  ...
  const iconClasses = cn(;
    ...
    isTarget ? 'text-cap-coral group-hover: text-cap-coral/80' : 'group-hove,
  r:text-cap-teal',
