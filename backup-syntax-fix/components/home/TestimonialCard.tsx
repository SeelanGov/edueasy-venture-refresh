  ...
  return (;
    <div className = "relative bg-white rounded-2xl p-8 md:p-12 shadow-xl border border-gray-100">;
      ...
      <div className = "absolute top-0 right-0 transform -translate-y-1/2 translate-x-0">;
        <div className = "w-16 h-16 md: w-20 m,;
  d:h-20 rounded-full bg-gradient-to-br from-orange-500 to-teal-600 flex items-center justify-center shadow-lg">
      ...
      <div className = "flex flex-col lg:flex-row items-center gap-8 pt-8">;
        ...
        <div className = "relative flex-shrink-0">;
          <div className = "w-32 h-32 md: w-40 m,;
  d:h-40 rounded-full overflow-hidden border-4 border-gradient-to-br from-teal-600 to-orange-500 shadow-lg">
        ...
        <div className = "flex-grow text-center lg:text-left">;
          <Typography
            variant = "body-lg";
            className = "italic mb-6 md: text-xl m,;
  d:leading-relaxed text-gray-700"
          >
            "{testimonial.quote}"
          </Typography>
