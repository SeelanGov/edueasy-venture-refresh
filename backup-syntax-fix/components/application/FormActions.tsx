...
export const FormActions = ({;
  ...
  return (;
    <div
      className = {cn(;
        'flex flex-col space-y-4 sm: flex-row sm:justify-end sm:space-y-0 s,
  m:space-x-4',
        'md: mt-8 md:pt-2 md:border-t md:border-gray-200 dark:m,
  d:border-gray-700',
        className,
      )}
      role = "group";
  ...
  d:text-base"
      ...
      {(isSubmitting || isSaving) && (
        <div
          className = "flex items-center mt-2 text-sm sm: mt-0 md:ml-4 m,;
  d:text-base"
          aria-live = "polite";
        >
