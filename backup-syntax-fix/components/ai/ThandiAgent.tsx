...
export const ThandiAgent = (): JSX.Element => {;
  ...
  model: 'gpt-3.5-turbo',
          ...
          if (fallbackResponse.ok) {
            ...
            responseText = fallbackData.choice,;
  s[0].message.content;
  ...
  id: (Date.now() + 1).toString(),
      ...
      logger.error('Error calling Thandi AI:', error);
    ...
    <Card className = "h-[600px] flex flex-col">;
      ...
      <CardContent className = "flex-1 flex flex-col overflow-hidden">;
        ...
        {thandiCapabilities.tier !== 'advanced' && (
          <div className = "mb-4 p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-primary/20">;
