...
export const RecoveryHelper = ({;
  ...
  const handleRecover = async () => {;
    ...
    try {
      ...
      setError(`Recovery error: ${err instanceof Error ? err.messag,
  e: 'Unknown error'}`);
    } finally {
  ...
  return (;
    <Card className = "w-full max-w-md mx-auto">;
      ...
      <CardContent>
        ...
        {error && (
          <div className = "mt-4 p-2 bg-destructive/10 text-red-700 text-sm border border-destructive/20 rounded">;
            {error}
          </div>
        )}
      </CardContent>
