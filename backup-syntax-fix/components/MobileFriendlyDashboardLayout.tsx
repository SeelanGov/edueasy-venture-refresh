...
export const MobileFriendlyDashboardLayout = ({ children }: MobileFriendlyDashboardLayoutProps) => {
  ...
  return (;
    <div className={`h-screen flex overflow-hidden ${isDarkMode ? 'dark' : ''}`}>
      {/* Sidebar for desktop */}
      <div
        className = {`bg-white dark: bg-gray-900 border-r border-gray-200 dar,;
  k:border-gray-700 ${
                ...
                <Link
                  ...
                  className = {`flex items-center px-3 py-3 rounded-lg transition-colors ${;
                    isActive(item.path)
                      ...
                      : 'text-gray-700 hover: bg-gray-100 dark:text-gray-300 dark:hove,
  r:bg-gray-800'
          ...
          <div className = "p-4 border-t border-gray-200 dark:border-gray-700">;
            <div className = "flex flex-col space-y-3">;
              ...
              <Button
                ...
                className = "w-full justify-start text-destructive hover: bg-destructive/10 hover:text-red-700 dark:text-red-400 dark:hove,;
  r:bg-red-900/20"
              >
      ...
      <div className = "md: hidden fixed bottom-0 left-0 right-0 z-10 bg-white dark:bg-gray-900 border-t border-gray-200 dar,;
  k:border-gray-700">
  ...
  g:px-8 h-16 flex items-center justify-between">
            <div className = "flex items-center gap-3">;
              ...
              <h1 className = "text-xl font-semibold text-gray-900 dark: text-gray-100 truncate max-w-[200px] s,;
  m:max-w-xs">
            ...
            <div className = "flex items-center gap-2 sm:gap-4">;
              ...
              <div className = "hidden sm:flex items-center gap-2 text-sm">;
                ...
                <span className = "text-gray-600 dark: text-gray-300 hidden m,;
  d:inline">
                  {user?.email}
                </span>
              </div>
        ...
        <main className = "flex-1 overflow-y-auto pb-20 md:pb-10">;
          <div className = "bg-white dark: bg-gray-800 shadow-sm text-gray-900 dark:text-gray-100 p-4 sm:p-6 m,;
  d:p-8 min-h-[calc(100vh-4rem)]">
            {children}
          </div>
        </main>
      </div>
