...
describe('VerifyId Component', () => {
  ...
  describe('Feature Flag Tests', () => {
    it('should hide component when feature flag is disabled', () => {
      ...
      expect(screen.getByText('ID verification is currently unavailable. Please try again later.')).toBeInTheDocument();
    ...
    it('should show component when feature flag is enabled', () => {
      ...
      expect(screen.queryByText('ID verification is currently unavailable')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Consent Flow', () => {
    ...
    it('should return to idle state when cancel is clicked', () => {
      ...
      expect(screen.queryByText('By proceeding, you consent to verify your South African ID number')).not.toBeInTheDocument();
    });
  });
