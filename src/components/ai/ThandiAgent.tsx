...
import { Bot, X, MessageCircle, Send, ChevronDown } from "lucide-react";
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-4">
                  ...
                  <div className="grid grid-cols-1 gap-2 w-full max-w-xs">
                    <Button 
                      ...
                      onClick={() => sendMessage("What's the status of my documents?")}
                    >
                    ...
                    <Button 
                      ...
                      size="sm" 
                      className="text-xs justify-start" 
                      onClick={() => sendMessage("How do I choose a program?")}
                    >
                    ...
                    <Button 
                      ...
                      size="sm" 
                      className="text-xs justify-start" 
                      onClick={() => sendMessage("When are the application deadlines?")}
                    >
