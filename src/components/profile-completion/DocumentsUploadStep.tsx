          ...
          <Card>
            <CardContent className="pt-6">
              <DocumentUploadInput
                ...
                onResubmit={() => handleResubmit("idDocument")}
              ...
              <DocumentUploadInput
                ...
                onRetry={handleRetry}
                onVerify={handleManualVerify}
                onResubmit={() => handleResubmit("proofOfResidence")}
                verificationResult={verificationResult}
                isVerifying={isVerifying}
                setCurrentDocumentType={setCurrentDocumentType}
                currentDocumentType={currentDocumentType}
              ...
              <DocumentUploadInput
                ...
                onRetry={handleRetry}
                onVerify={handleManualVerify}
                onResubmit={() => handleResubmit("grade11Results")}
                verificationResult={verificationResult}
                isVerifying={isVerifying}
                setCurrentDocumentType={setCurrentDocumentType}
                currentDocumentType={currentDocumentType}
              ...
              <DocumentUploadInput
                ...
                onRetry={handleRetry}
                onVerify={handleManualVerify}
                onResubmit={() => handleResubmit("grade12Results")}
                verificationResult={verificationResult}
                isVerifying={isVerifying}
                setCurrentDocumentType={setCurrentDocumentType}
                currentDocumentType={currentDocumentType}
