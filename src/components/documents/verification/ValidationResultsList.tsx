...
export const ValidationResultsList = ({ validationResults, extractedFields }: ValidationResultsListProps) => {
        ...
        <div>
          ...
          <div className="text-xs space-y-1">
            {Object.entries(validationResults).map(([key, value]) => (
              key !== 'documentType' && key !== 'error' && key !== 'failureReason' && key !== 'isValid' && (
