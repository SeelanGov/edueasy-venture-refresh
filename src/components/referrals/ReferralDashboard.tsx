        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">{formatCurrency(referralStats.totalRewards)}</span>
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          {referrals.length === 0 ? (
            ...
            <Tabs defaultValue="all">
              ...
              <TabsContent value="all">
                <ReferralTable referrals={referrals} formatDate={formatDate} getStatusBadgeVariant={getStatusBadgeVariant} />
              </TabsContent>
