...
export const PaymentRecoveryNotice = () => {
    ...
    <Card className="border-amber-200 bg-amber-50">
      <CardHeader>
        ...
        <CardDescription className="text-amber-800">
          We found some payments that might belong to your account. You can claim them or retry the payment process.
        </CardDescription>
      </CardHeader>
          ...
          <>
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-amber-800">
                {recoverablePayments.length} payment{recoverablePayments.length !== 1 ? 's' : ''} found
              </span>
              <Button
                variant="outline"
                size="sm"
            ...
            <Alert className="border-amber-200 bg-amber-100">
              ...
              <AlertDescription className="text-amber-800">
                <strong>Need help?</strong> If you're unsure about these payments or need assistance, 
                please contact our support team at{' '}
                <a 
                  href="mailto:support@edueasy.co.za" 
