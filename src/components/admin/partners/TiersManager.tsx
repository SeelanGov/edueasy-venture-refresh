...
export const TiersManager = () => {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-64">Loading tier configurations...</div>;
  }
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {tier.max_applications || 'Unlimited'}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>API Rate Limit</span>
                  <span className="font-medium">
                    {tier.api_rate_limit || 'Unlimited'}/hour
                  </span>
                </div>
              </div>
