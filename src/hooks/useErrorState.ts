...
export const useErrorState = (config: Partial<ErrorHandlingConfig> = {}) => {
  ...
  const reportError = useCallback(async (
    ...
    const standardError = error instanceof Error ? parseError(error) : {
    ...
    if (
      ...
      (
        ...
        (errorConfig.reportingThreshold === ErrorSeverity.WARNING && severity === ErrorSeverity.WARNING) ||
