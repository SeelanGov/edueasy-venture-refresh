      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-background-subtle">
        ...
        <div className="bg-card p-8 rounded-xl shadow-lg w-full max-w-xl text-center">
          ...
          <p className="mb-4 text-foreground-muted">
            To access all partner features, please complete your subscription payment via EFT or
            your business banking app.
            <br />
            <br />
            Once payment is confirmed by EduEasy, your dashboard and partner features will be fully
            unlocked.
          </p>
          <Button
