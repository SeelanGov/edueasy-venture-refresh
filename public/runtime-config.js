// client-safe only (public anon key)
console.log("[runtime-config] injecting client env...");
...
console.log("[runtime-config] ready:", !!window.__RUNTIME_CONFIG__.VITE_SUPABASE_URL);