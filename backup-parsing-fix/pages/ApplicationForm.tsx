    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        >
          {hasSavedDraft && (
            <div
              className="mb-6 text-sm md:text-base text-success bg-success/10 dark:text-green-400 dark:bg-green-900/20 p-2 md:p-3 rounded border border-success/20 dark:border-green-800"
              role="status"
              aria-live="polite"
            >
