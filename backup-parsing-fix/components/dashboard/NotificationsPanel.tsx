...
export const NotificationsPanel = () => {
  ...
  const renderNotificationContent = (notification: Notification) => {
    return (
      <div
        className={`p-4 ${notification.is_read ? 'bg-white dark:bg-gray-800' : 'bg-primary/10 dark:bg-blue-900/20'} transition-colors duration-200`}
      >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="w-full justify-start text-xs text-red-500 hover:text-destructive hover:bg-destructive/10 dark:hover:bg-red-950/10"
