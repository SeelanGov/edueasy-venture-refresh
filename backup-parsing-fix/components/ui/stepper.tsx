            ...
            >
              <div className="relative flex items-center justify-center">
                {step.status === 'complete' ? (
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-green-100 text-success">
                    <Check className="h-3.5 w-3.5" />
                  </div>
                ) : step.status === 'error' ? (
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-red-100 text-destructive">
