...
const badgeDescriptions: Record<string, string> = {
  encryption:
    'Encryption: Your data is encrypted both in transit and at rest, ensuring only authorized access.',
  'data-protection':
...
export const SecurityInfoPanel: React.FC<SecurityInfoPanelProps> = ({ badgeType }) => (
  <div className="flex items-center gap-3 p-4 bg-primary/10 dark:bg-zinc-800 rounded-lg border border-primary/20 dark:border-zinc-700">
