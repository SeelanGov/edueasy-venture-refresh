...
export const DocumentPreview = ({
  ...
  if (error || !url) {
    return (
      <div className={`flex flex-col items-center justify-center ${className}`}>
        <div
          className={`${sizeClasses[size]} border border-gray-300 rounded-md bg-gray-50 flex items-center justify-center`}
        >
  ...
  if (isPdf) {
    return (
      <div className={`flex flex-col items-center ${className}`}>
        <div
          className={`${sizeClasses[size]} border border-gray-300 rounded-md bg-gray-50 flex flex-col items-center justify-center p-4`}
        >
